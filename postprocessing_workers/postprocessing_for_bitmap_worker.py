...
def postprocessing_for_bitmap_worker_multiple_image(map_id, legend_id, this_map_name, this_legend_name, data_dir0, data_dir1, data_dir2, data_dir3, data_dir4, target_dir_img, target_dir_mask, target_dir_img_small, target_dir_mask_small):
